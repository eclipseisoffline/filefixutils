...
dependencies {
    ...
    implementation("xyz.eclipseisoffline:filefixutils-common:0.1.3-26.1")
    
    // For your Fabric module:
    implementation("xyz.eclipseisoffline:filefixutils-fabric:0.1.3-26.1")
    
    // For your NeoForge module:
    implementation("xyz.eclipseisoffline:filefixutils-neoforge:0.1.3-26.1")
}
```
...
multimod {
    ...
    sharedDependencies {
        multiModInclude(multiModImplementation("xyz.eclipseisoffline:filefixutils:0.1.3-26.1"))
    }
}
```
